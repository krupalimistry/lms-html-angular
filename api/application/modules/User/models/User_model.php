...
class User_model extends CI_Model
{
	...
	public function getlist_user()
	{
		...
		$this->db->select('us.*,cp.*,cp.CompanyId');
		$this->db->join('tblcompany cp','cp.CompanyId = us.CompanyId', 'left');
		//$this->db->join('tblmstuserrole ur','ur.RoleId = us.RoleId', 'left');
	...
	//	$this->db->join('tblmststate sta', 'sta.StateId = user.UserId', 'left');
		...
		//  $this->db->select('UserId,RoleId,CompanyId,FirstName,LastName,Title,EmailAddress,Password,CountryId,StateId,City,ZipCode,PhoneNumber,PhoneNumberl,IsActive');
		//$this->db->where('user.UserId=',$user_id);
